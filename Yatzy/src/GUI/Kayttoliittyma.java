...
public class Kayttoliittyma implements Runnable {
    ...
    private JPanel luoNopat() {
        ...
        Icon noppa1img = new ImageIcon("noppa4.jpg");
        noppa1 = new JButton(noppa1img);
        noppaPaneli.add(noppa1);
        
       

        Icon noppa2img = new ImageIcon("noppa4.jpg");
        noppa2 = new JButton(noppa2img);
        noppaPaneli.add(noppa2);


        Icon noppa3img = new ImageIcon("noppa4.jpg");
        ...
        Icon noppa5img = new ImageIcon("noppa4.jpg");
