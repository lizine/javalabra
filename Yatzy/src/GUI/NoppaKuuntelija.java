...
/**
 * Tässä Kuuntelija-luokassa luodaan tapahtumankuuntelija, joka seuraa käyttöliittymässä "heitä noppaa" napin
 * klikkaamista. Kun nappia painetaan, generoidaan nopille yatzyluokassa silmäluku. Tässä luokassa etsitään silmälukua 
 * vastaava nopan kuva käyttöliittymässä näytettäväksi.
...
public class NoppaKuuntelija implements ActionListener {
    ...
    /**
     * Noppakuuntelija saa konstruktorissa Käyttöliittymältä noppia vastaavat napit, sekä yatzy olion ja noppien
     * silmäluvut sisältävän listan.
     * @param noppa1
     * @param noppa2
     * @param noppa3
     * @param noppa4
     ...
     * 
     * @param e 
     * Kun "heitä noppaa" -JButtonia painetaan, kutsutaan esnin yatzyn pelaa kierros metodia,joka saa noppien silmäluvut
     * muuttumaan. Tämän jälkeen katsotaan noppien silmäluvut sisältävästä taulukosta kunkin nopan silmäluku ja näytetään sitä
     * vastaava kuva käyttöliittymässä olevassa noppaa vastaavassa JButtonissa.
     * 
